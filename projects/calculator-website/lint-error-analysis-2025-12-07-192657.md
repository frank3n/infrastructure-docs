...
|------|------|-------|------------|
| 1 | `@typescript-eslint/no-explicit-any` | 411 | 95.4% |
| 2 | `prefer-const` | 14 | 3.2% |
| 3 | `@typescript-eslint/ban-ts-comment` | 3 | 0.7% |
| 4 | `react-hooks/rules-of-hooks` | 3 | 0.7% |
...
|------|------|-------------|
| 1 | `src\services\deepl.ts` | 285 |

---

## Detailed Error Breakdown by Rule

### `@typescript-eslint/no-explicit-any` (411 errors)

**Top affected files:**

- `src\services\deepl.ts` - 274 occurrence(s)
...
#### Fix `@typescript-eslint/no-explicit-any` (411 errors)
