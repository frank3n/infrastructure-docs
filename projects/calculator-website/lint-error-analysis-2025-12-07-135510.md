...
**Generated:** 2025-12-07 13:55:10
**Log Files Analyzed:** 4
**Total Errors:** 292
...
|------|------|-------|------------|
| 1 | `@typescript-eslint/no-explicit-any` | 274 | 93.8% |
| 2 | `prefer-const` | 14 | 4.8% |
| 3 | `@typescript-eslint/ban-ts-comment` | 2 | 0.7% |
| 4 | `react-hooks/rules-of-hooks` | 2 | 0.7% |
...
|------|------|-------------|
| 1 | `src\services\deepl.ts` | 146 |

---

## Detailed Error Breakdown by Rule

### `@typescript-eslint/no-explicit-any` (274 errors)

**Top affected files:**

- `src\services\deepl.ts` - 137 occurrence(s)
...
- `src\services\deepl.ts` - 1 occurrence(s)

### `react-hooks/rules-of-hooks` (2 errors)
...
#### Fix `@typescript-eslint/no-explicit-any` (274 errors)
...
#### Fix `@typescript-eslint/ban-ts-comment` (2 errors)
